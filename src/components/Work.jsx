...
const projects = [
  ...
  { number:'08', type:'VRLS DEMO / CONCEPT', title:'Furniture Store', description:'Product catalogue, categories, specifications and customer enquiries.', tags:['Catalogue','Retail','Products'], icon: Sofa, className:'work-furniture', demo:'/demos/furniture', image:'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=65' },
  { number:'09', type:'VRLS DEMO / CONCEPT', title:'Education', description:'Coaching, school and college website concept with courses, faculty and admissions.', tags:['Education','Admissions','CMS'], icon: GraduationCap, className:'work-education', demo:'/demos/education', image:'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=800&q=65' },
  { number:'10', type:'VRLS DEMO / CONCEPT', title:'Hospital / Clinic Management', description:'Clinic management dashboard with patients, doctors, appointments, billing and patient booking.', tags:['Healthcare','Appointments','Management'], icon: Hospital, className:'work-hospital', demo:'/demos/hospital', image:'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=800&q=65' },
]

function toResponsiveImageUrl(url, width, quality = 60) {
  return url.replace(/w=\d+/, `w=${width}`).replace(/q=\d+/, `q=${quality}`)
}

function ProjectPreview({ project }) {
  const mobileImage = toResponsiveImageUrl(project.image, 480, 58)
